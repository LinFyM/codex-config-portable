...
In this environment, these three files are intended to be committed to git with the related task work unless the user explicitly asks otherwise.
...
| Don't | Do Instead |
|-------|------------|
| Use only update_plan for persistence | Use update_plan for session tracking and keep task_plan.md/findings.md/progress.md as durable records |
